    ...
    function loadReportCB(report) {
        ...
        for (var i=0; i<report.points.length; i++)
            addToReportPointsArray(report.points[i].pointId, report.points[i].colour,
                    report.points[i].consolidatedChart, report.points[i].scatterChart, report.points[i].plotTitle(),
                    report.points[i].XAxisTitle, report.points[i].YAxisTitle, report.points[i].YAxisTitle, report.points[i].referenceLine());
